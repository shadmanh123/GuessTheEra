...
import group10.com.guesstheera.databinding.MultiplayerFragmentGameOptionsBinding

class MultiplayerGameOptionsFragment: Fragment() {
    private var _binding: MultiplayerFragmentGameOptionsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = MultiplayerFragmentGameOptionsBinding.inflate(inflater, container, false)
        val root: View = binding.root

        regularModeButton = root.findViewById(R.id.option_regular_mode)
        regularModeButton.setOnClickListener {
            val intent = Intent(context, OnlineGameStartActivity::class.java)
